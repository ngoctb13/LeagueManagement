 ...
 * @author Admin
 */
public class ArrangeMatchServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        boolean matchScheduleExists = matchDAO.checkMatchScheduleExists(tour_id);

        List<Match> matches;
        ArrayList<Team> teamList = dao.getListTeamByTour(tour_id);
        
        if (matchScheduleExists) {
            matches = matchDAO.getMatchSchedule(tour_id);
        } else {
            ...
            matchDAO.storeMatchSchedule(tour_id, matches);
        }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(ArrangeMatchServlet.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
