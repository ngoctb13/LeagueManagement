 ...
 * @author HP
 */
public class DeclineTeamRequestServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        int decline = userDao.updateStatusDeclineTeamRequest(user_id);
        if (decline > 0) {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(DeclineTeamRequestServlet.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
