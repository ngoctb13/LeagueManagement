                ...
                <div class="row col-10">                       
                    ...
                    <div class="col-lg-8 mt-4">
                        ...
                        <form action="updateMatchesSchedule">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="header-title">Setting League Schedule</h4>
                                    <div class="single-table">
                                        <div class="table-responsive">
                                            <table class="table text-center">
                                                <thead class="text-uppercase">
                                                ...
                                                <tbody>
                                                    <c:forEach var="match" items="${matches}">
                                                        <tr>
                                                            ...
                                                            <td><select name="homeTeam_${match.match_id}">
                                                                    <option value="">Select Home Team</option>
                                                                    <c:forEach var="team" items="${teamList}">
                                                                        <option value="${team.team_id}" ${team.team_id == match.hometeam.team_id ? 'selected' : ''}>${team.team_name}</option>
                                                                    </c:forEach>
                            ...
                            <div class="row">
                                <div class="col-xl-1 col-lg-2 col-md-3 col-sm-6 mb-4">
                                    <button type="submit" class="btn btn-primary btn-flat btn-lg mt-3">Submit</button>
                                </div>
                            </div>
                        </form>
                    </div>
